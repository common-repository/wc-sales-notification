...
if ( !class_exists( 'WC_Sale_Notification_Settings_API' ) ):
class WC_Sale_Notification_Settings_API {
            ...
            jQuery(document).ready(function($) {
                ...
                $('.wpsa-browse').on('click', function (event) {
                    ...
                    file_frame.on('select', function () {
                        ...
                        self.parent().siblings('.htmedia_display').html('<img src="'+attachment.url+'" alt="" />');
                    });
                ...
                $('.wpsa-remove').on('click', function (event) {
                    event.preventDefault();
                    var self = $(this);
                    self.parent().siblings('.wpsa-url').val('').change();
                    self.parent().siblings('.htmedia_display').html('');
                });
